...
const batteryModeService_1 = __importDefault(
  require("./modes/batteryModeService"),
);
...
class MaxxiChargeAdapter extends utils.Adapter {
  ...
  async onReady() {
    try {
      ...
      this.deviceRegistry = new deviceRegistry_1.default(
        this,
        this.stateManager,
      );
      this.commandService = new commandService_1.default(
        this,
        this.stateManager,
        this.requestClient,
      );
      ...
      this.log.error(
        `Fatal error during initialization: ${error instanceof Error ? error.message : String(error)}`,
      );
      await this.dispose();
    }
  }
