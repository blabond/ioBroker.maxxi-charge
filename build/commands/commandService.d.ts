...
export type CommandId = "maxOutputPower" | "offlinePower" | "baseLoad" | "offlineOutput" | "threshold" | "minSOC" | "maxSOC" | "autoCalibration";
export default class CommandService {
    ...
    applyDeviceSetting(deviceId: string, commandId: CommandId, rawValue: unknown, options?: {
        source?: string;
    }): Promise<boolean>;
