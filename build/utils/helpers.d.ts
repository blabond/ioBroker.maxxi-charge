export declare function nameToId(value: string | number | null | undefined): string;
export declare function normalizeDeviceId(value: string | number | null | undefined): string;
export declare function validateInterval(value: number, min?: number, max?: number): number;
