...
export function normalizeConfig(rawConfig: AdapterConfig): RuntimeConfig {
    ...
    const legacyCcuIntervalMs = validateInterval(ccuIntervalSeconds * 1_000, CLOUD_CCU_MIN_INTERVAL_MS, 3_600_000);
    ...
    return {
        ...
        ccuIntervalMs: apiMode === 'cloud' ? CLOUD_CCU_INTERVAL_MS : legacyCcuIntervalMs,
