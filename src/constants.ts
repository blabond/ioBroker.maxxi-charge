...
export const CLOUD_CCU_INTERVAL_MS = 5_000;
export const CLOUD_CCU_MIN_INTERVAL_MS = CLOUD_CCU_INTERVAL_MS;
export const CLOUD_CCU_REQUEST_TIMEOUT_MS = 3_500;
export const CLOUD_RETRY_COUNT = 3;
export const CLOUD_RETRY_DELAY_MS = 2_000;
export const CLOUD_FAILURE_LOG_THROTTLE_MS = 5 * 60_000;
...
export const ECO_WINTER_MIN_SOC = 60;
export const ECO_WINTER_RELAXED_MIN_SOC = 40;
export const ECO_SUMMER_MIN_SOC = 10;
export const BATTERY_CALIBRATION_EMPTY_SOC = 10;
export const BATTERY_CALIBRATION_FULL_SOC = 98;
