...
describe('EcoModeService', () => {
    ...
    function createService({ activeDeviceIds = ['ccu1', 'ccu2'], applyDeviceSetting = async () => true } = {}) {
        const commandCalls = [];
        const scheduledJobs = [];
        ...
        return {
            service: new EcoModeService(adapter, config, scheduler, commandService, deviceRegistry),
            commandCalls,
            scheduledJobs,
        };
    }
